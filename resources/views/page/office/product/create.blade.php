                            ...
                            <div class="mb-0">
                                ...
                                <div class="row gx-12 mb-5">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-5">
                                            <input type="text" id="weight" name="weight" class="form-control form-control-solid" placeholder="berat" />
                                        </div>
                                        <div class="mb-5">
                                            <textarea id="description" name="description" class="form-control form-control-solid" placeholder="Description"></textarea>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                </div>
                                <div class="row gx-12 mb-5">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="tel" maxlength="19" id="price" name="price" class="form-control form-control-solid" placeholder="Price"  />
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="tel" maxlength="5" id="stock" name="stock" class="form-control form-control-solid" placeholder="Stock"  />
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <div class="col-lg-12">
                                ...
                                <!--end::Row-->
                                 <!--begin::Button-->
                                 <div class="mb-0">
                                    <button id="tombol_simpan" onclick="handle_upload('#tombol_simpan','#form_input','{{route('office.product.store')}}','POST');" class="btn btn-light-primary">Save</button>
                                </div>
                                <!--end::Button-->
                            </div>
                            <!--end::Wrapper-->
