                            ...
                            <div class="mb-0">
                                ...
                                <div class="row gx-12 mb-5">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="tel" maxlength="19" id="price" name="price" class="form-control form-control-solid" placeholder="Price" value="{{$product->price}} " />
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="tel" maxlength="5" id="stock" name="stock" class="form-control form-control-solid" placeholder="Stock"  value="{{$product->stock}} "/>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <div class="col-lg-12">
                                ...
                                <!--begin::Button-->
                                <div class="mb-0">
                                    <button id="tombol_simpan" onclick="handle_upload('#tombol_simpan','#form_input','{{route('office.product.update',$product->id)}}','PUT','Save');" class="btn btn-light-primary">Save</button>
                                </div>
                                <!--end::Button-->
                            </div>
                            <!--end::Wrapper-->
