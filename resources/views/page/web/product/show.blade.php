                                    ...
                                    <div class="fslider" data-pagi="false" data-arrows="false" data-thumbs="true">
                                        <div class="flexslider">
                                            <div class="slider-wrap" data-lightbox="gallery">
                                                <div class="slide" data-thumb="{{$product['photo']}}">
                                                    <a href="{{$product['photo']}}" title="{{$product['name']}}" data-lightbox="gallery-item">
                            ...
                            <form id="form_cart">
                                <div class="cart mb-0 d-flex justify-content-between align-items-center">
                                    ...
                                    @if(\Session::get('token'))
                                        <button type="button" onclick="add_cart('#tombol_keranjang','#form_cart','{{route('web.cart.checkout')}}','Add to Cart','{{$product['id']}}');" id="tambah_keranjang" class="add-to-cart button m-0">Buy</button>
                                    @else
                                        <a href="{{route('web.auth.index')}}" class="add-to-cart button m-0">Buy</a>
                                    @endif
                                </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-sm-6">
                                        <h5 class="fw-medium mb-3">Stock Left:</h5>
                                    </div>
                                </div>
                                <ins id="stock" style="text-decoration:none; color:red;">Stock : {{number_format($product['stock'])}}</ins>
                            </form>
