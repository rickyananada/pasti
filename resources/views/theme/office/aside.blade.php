        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    ...
                    {{-- <div class="menu-item">
                        <a class="menu-link {{request()->is('office/banner') ? 'active' : ''}}" href="#">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div data-kt-menu-trigger="click" class="menu-item {{request()->is('office/customer') || request()->is('office/employee') ? 'here show' : ''}} menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion {{request()->is('office/customer') || request()->is('office/employee') ? 'menu-active-bg' : ''}}">
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('office/customer') ? 'active' : ''}}" href="#">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('office/employee') ? 'active' : ''}}" href="#">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
